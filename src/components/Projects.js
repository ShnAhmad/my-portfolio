  ...
  return (
    ...
    >
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div
          ref={containerRef}
          className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-6 md:gap-8 md:px-2 md:grid-cols-1 lg:grid-cols-2"
        >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Back of card */}
                  {/* Back of card */}
                  <div className="absolute inset-0 h-full w-full backface-hidden rotate-y-180 rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl p-4 sm:p-6 overflow-hidden">
                    {/* Background overlay */}
                    ...
                    <div className="relative z-10 flex h-full min-h-0 flex-col">
                      ...
                      <div className="mb-3 flex shrink-0 items-center gap-3 sm:mb-4">
                        <div
                          className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-${project.color}-600/30 border border-${project.color}-400/30`}
                        >
                          <Icon
                        ...
                        <h3 className="min-w-0 truncate text-base font-bold text-white sm:text-lg">
                          {project.title}
                        </h3>
                      </div>
